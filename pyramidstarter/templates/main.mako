...
<p></p>
<h1>Applications</h1>
<div class="list-group"><a href="main/mutantprimers" class="list-group-item"><b>Primers &#x2014; Mutant primers:</b><br>Given
    a sequence and list of desired mutations it will return primers to make each of those mutations.</a>
    <a
            href="main/deepscan" class="list-group-item"><b>Primers &#x2014; Deepscan:</b>
    ...
    <a
            href="main/mutantcaller" class="list-group-item"><b>epPCR&#xA0;&#x2014; Mutantcaller:</b>
    ...
    <a
            href="main/probably" class="list-group-item"><b>epPCR&#xA0;&#x2014; Chances:</b>
        <br>Given a sequence and a desired mutation, it will say what are the chances
        that mutation ought to have been seen.</a> <a href="main/silico" class="list-group-item"><b>epPCR&#xA0;&#x2014;
        Generator:</b><br> Given a sequence and mutational bias data, it generate mutations.</a>
    <a
            href="main/glue" class="list-group-item"><b>Glue&#xA0;&#x2014; Glue:</b>
        <br>Calculates how complete a library is from a coupon collectors problem
        standpoint.</a> <a href="main/glue" class="list-group-item"><b>Glue&#xA0;&#x2014; GlueIT:</b><br> Calculates the
        completeness of a library mutated at 1&#x2013;6 codons.</a>
    <a
            href="main/driver" class="list-group-item"><b>Driver:</b>
        <br>Calculates the probability of cross-over events</a> <a href="main/QCC"
                                                                   class="list-group-item"><b>QQC (Quick quality
    ...
    <a
            href="main/landscape" class="list-group-item"><b>Landscape:</b>
        <br>Given a series of Rosetta pmut_scan outputs it shows the mutational landscape
        of that protein</a> <a href="main/misc" class="list-group-item"><b>Codon helper</b><br> A tool to help you pick
