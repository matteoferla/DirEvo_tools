...
window.tutorial = new Tour({
  steps: [
  {
    ...
    title: "Aim",
    content: "Plan your experiment to get a given amount of mutations before doing an epPCR or predict what you may get from your PCR yield.",
    placement: 'bottom'
  },
  {
    element: "#planner_method",
    title: "Mode",
    content: 'The app has two modes. In the planner mode, you have yet to do the epPCR and would like to know how much template to add in order to achieve a given load (say 5 mutations on average).',
    placement: 'top',
