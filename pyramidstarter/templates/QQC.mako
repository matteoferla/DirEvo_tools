<div class="card">
            ...
            <div class="card-body">
                ...
                <p>Site saturation mutagenesis uses primers with a degenerate codon to scramble
                    ...
                    target="_blank"><span data-toggle="tooltip" data-placement="top" title="Acevedo-Rocha, CG, Reetz, MT, Nov, Y., (2015). Economical analysis of saturation mutagenesis experiments. Sci. Rep. 5:10654">Acevedo-Rocha <i>et al.</i>, 2015 <i class="fas fa-external-link" aria-hidden="true"></i></span></a>).</p>
                ...
                <div align="center">
                    <img src="/static/eq_QQC_white-01.svg" alt="equation 1" height="82 em">
                </div>
                <p>where <i><b>x</b></i> is a scaling factor (4x3xN tensor) of the deviation
...
is the empirical proportions of bases (4x3
                    ...
                    tensor). This approach therefore tries to balance the primers so to minimise
                    ...
                    <div class="col-xl-4">
                        <div class="input-group"> <div class="input-group-append" data-toggle="tooltip" title="The mutation used. The input is a string which can be simply four bases (e.g. &apos;NNK&apos;) or multiple codons separated by a space and optionally prefixed with a interger number denoting their ratios (e.g. &apos;12NDT 6VHA 1TGG 1ATG&apos;) or a special mix (e.g. &apos;Tang&apos;)."
                            ...
                            placeholder="NNK" id="QQC_mutation"> <span class="input-group-btn">
                                ...
                                <button class="btn btn-secondary" type="button" data-toggle="modal" data-target="#scheme_modal"><i class="fas fa-flask" aria-hidden="true"></i></button>
...
Clear</button>
                            <button type="button"
                            class="btn btn-info" id="QQC_demo"><i class="fas fa-files-o" aria-hidden="true"></i> Demo</button>
                            <button type="button"
                ...
                <!-- <div class="row hidden" id="QQC_download">
                        ...
                        <div class="col-xl-9">
                            ...
                            <div class="btn-group" role="group" aria-label="...">
                                ...
                                <button type="button" class="btn btn-success" id="DS_table"><i class="fas fa-bars" aria-hidden="true"></i> CSV

                                </button>

                                <button type="button" class="btn btn-warning" id="DS_json"><i class="fas fa-cog" aria-hidden="true"></i> JSON

                                </button>

                                <button type="button" class="btn btn-info" id="DS_IDT_bulk"><i class="fas fa-shopping-basket" aria-hidden="true"></i> IDT bulk

                                </button>

                                <button type="button" class="btn btn-info" id="DS_IDT_plate"><i class="fas fa-shopping-cart" aria-hidden="true"></i> IDT plate
