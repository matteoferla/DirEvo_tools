...
def main(global_config, **settings):
    ...
    for route in 'deepscan mutanalyst misc admin about log QQC pedel driver glue mutantcaller ajax_test ajax_deepscan deepscan_IDT96 deepscan_IDT384 ajax_QQC ajax_pedel ajax_glue ajax_mutantcaller facs2excel ajax_facs ajax_codon personal original_mutanalyst'.split():
